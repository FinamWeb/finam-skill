...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID/orders", nil)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID/orders")
        .bearer_auth(token)
        .send().await?;
...
curl -X GET 'https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID/orders' \
