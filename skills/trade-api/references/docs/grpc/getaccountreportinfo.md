...
**Path:** /grpc.tradeapi.v1.reports.ReportsService/GetAccountReportInfo
...
| info.url | StringValue | no | Ссылка на скачивание отчёта. Появляется только в случае успешной генерации отчёта (ReportCreationStatus = SUCCESS) |
...
grpcurl \
  ...
  api.finam.ru:443 grpc.tradeapi.v1.reports.ReportsService/GetAccountReportInfo
```